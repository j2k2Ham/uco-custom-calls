...
export function Hero() {
  return (
    <section className="relative h-[60vh] min-h-[460px] flex items-stretch">
      <div className="absolute inset-0 bg-[url('/images/waterfowl-lab-splash-page.jpg')] bg-cover bg-center" aria-hidden />
