...
interface CategoryPageFrameClientProps { title: string; children: ReactNode; productCount?: number; activeHandle?: string; onSelectHandle?: (h: string)=>void; }

export function CategoryPageFrameClient({ title, children, productCount, activeHandle, onSelectHandle }: CategoryPageFrameClientProps) {
